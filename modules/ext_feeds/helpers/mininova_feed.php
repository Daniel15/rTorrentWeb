...
/**
 * Helper for the Mininova feed
 *
 * The Mininova feed is UGLY
 *  - It's just generally hard to read on my screen but here goes
 *  - It does however provide a GUID (with the isPermaLink attribute which is not needed), and the torrent as an enclosure (good Mininova)
 *
 * Dunno if this will ever get used because mininova killed itself but... RIP Mininova!
 */
class mininova_feed
{
